<template>
  <div class="pageCon">
    ...
    :body="`Our reliable appliance repair service has been serving Beccles for over 25 years. Offering same day repairs where possible, with all our repairs being guaranteed and with no hidden charges. No matter the issue your appliance is having, rest assured we have the expertise to get it back up and running like new!`"/>
...
export default {
  data() {
    return {
      accordionData: [
        { id: 1, title: 'What area do you cover?', body: 'Anyrep Appliance repairs covers the Beccles area. So, if you reside there and need your appliance repaired, don’t hesitate to contact us straight away.', button: false },
  ...
  head: {
    title: 'Anyrep Appliance Repairs Beccles | Book online for next day',
    meta: [
      {
        hid: 'description',
        name: 'description',
