<template>
  <div class="pageCon">
    ...
    <!-- Banner -->
    <Banner
    :title="'We can repair any Hob brand and model!'"
    :title2="''"
    :subTitle="`If you have a faulty Hob, don't hesitate to call Anyrep today to get it fixed! Or view our store for an instant solution!`"
    ...
    <PageIntro
    :title="'Hob Repairs!'"
    :subTitle="'Over 25 years of experience repairing Hobs.'"
    :body="`When your Hob breaks down, the impact is drastic and so we ensure Anyrep will do all it can to get your cooker up and running like new. Most repairs are completed on the first visit and on the same day where possible.`"/>

    <!-- What We Fix -->
    <SlantTop/>
    <WhatWeFix
    :title="'All types of Hob problems resolved'"
    :subTitle="'There a multiple things that can go wrong, and we can fix them!'"
    :body="`If you are experiencing any of the issues seen bellow, or even something different. We assure our services are for you. We keep stock of common parts that go wrong for many brands of Hobs, and if we dont have the part you need, we have a supply network that can get us the parts needed within a couple days.`"
    ...
    <SlantTop/>
    <BookToday 
    :title="'Book your Hob repair today'"
...
export default {
  data() {
    return {
        issuesArray: [
            { id: 1, issue: 'Gas not lighting?' },
            { id: 2, issue: 'Gas not folowing?' },
            { id: 3, issue: 'Broken element?' },
            { id: 4, issue: 'Tripping electrics?' },
            { id: 5, issue: 'Cracked glass?' },
            { id: 6, issue: 'Not getting hot?' }
        ],
        accordionData: [
        ...
        bookBodyArray: [
          { id: 1, body: 'Our factory-trained technicians can repair Hobs of any make or model, and can also replace any damaged parts quickly.' },
          { id: 2, body: `If you call us before 10 am, we'll be able to fix your appliance the same day. So, regardless of the work your Hob needs, call us.` },
        ]
    }
  },
  head: {
