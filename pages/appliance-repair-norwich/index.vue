<template>
  <div class="pageCon">
    ...
    :body="`Our reliable appliance repair service has been serving Norwich for over 25 years. Offering same day repairs where possible, with all our repairs being guaranteed and with no hidden charges. No matter the issue your appliance is having, rest assured we have the expertise to get it back up and running like new!`"/>
...
export default {
  ...
  head: {
    ...
    meta: [
      {
        hid: 'description',
        name: 'description',
        content: 'Book online with Anyrep today for same or next day appliance repairs Norwich! Over 25 years experience, guaranteed repairs with no hidden costs.'
      },
      {
          hid: "og:url",
          property: 'og:url',
          content: 'https://anyrep.co.uk/appliance-repair-norwich/'
      },
      {
          hid: "og:type",
          property: 'og:type',
      ...
      },
      {
          hid: "og:title",
          property: 'og:title',
          content: 'Anyrep Appliance Repairs Norwich | Book online for next day'
      },
      {
          hid: "og:description",
    ...
    link: [
      {
        rel: 'canonical',
        href: 'https://anyrep.co.uk/appliance-repair-norwich/'
      }
    ]
  },
  mounted() {
