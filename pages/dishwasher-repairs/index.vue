<template>
  <div class="pageCon">
    ...
    <!-- Banner -->
    <Banner
    :title="'We can repair any Dishwasher brand!'"
    :title2="''"
    :subTitle="`If you have a faulty dishwasher, don't hesitate to call Anyrep today to get it fixed! Or view our store for an instant solution!`"
    ...
    :subTitle="'Over 25 years of experience repairing Dishwashers.'"
    :body="`If you’re in need of a prompt dishwasher repair in the Norwich, Norfolk region look no further. We understand how time consuming it is to wash your dishes by hand and so we are committed to providing you a quick repair at a competitive price.`"/>
    ...
    <SlantTop/>
    <BookToday 
    :title="'Book your Dishwasher repair today'"
  ...
  data() {
    return {
        issuesArray: [
            ...
            { id: 2, issue: 'Door hinge stuck?' },
            { id: 3, issue: 'Broken panels?' },
            { id: 4, issue: 'Tripping electrics?' },
            { id: 5, issue: 'Leaking?' },
            { id: 6, issue: 'Dishes not cleaning?' },
            { id: 7, issue: 'Leaking water?' },
            { id: 8, issue: 'Loud noises?' },
            { id: 9, issue: 'Not heating the water?' }
        ],
        accordionData: [
        ...
        bookBodyArray: [
          { id: 1, body: 'Our factory-trained technicians can repair Dishwashers of any make or model, and can also replace any damaged parts quickly.' },
          { id: 2, body: `If you call us before 10 am, we'll be able to fix your appliance the same day. So, regardless of the work your Dishwasher needs, call us.` },
        ]
    }
  },
  head: {
