<template>
  <div class="pageCon">
    ...
    :body="`Keep your food from spoiling! If your fridge freezer is faulty, don’t hesitate to call us.  We can do it all. We have over 25 years of experience in the trade and we can repair your refrigerator on the same day. Our engineers are regularly trained to service all models, including freestanding, integrated and built-in units from leading manufacturers.`"/>

    <!-- What We Fix -->
    <SlantTop/>
    <WhatWeFix
    :title="'All types of Fridge & Freezer problems resolved'"
    :subTitle="'There a multiple things that can go wrong, and we can fix them!'"
    :body="`If you are experiencing any of the issues seen bellow, or even something different. We assure our services are for you. We keep stock of common parts that go wrong for many brands of Fridges and Freezers, and if we dont have the part you need, we have a supply network that can get us the parts needed within a couple days.`"
    :issuesArray="issuesArray"
    :image="'friedgeAndFreezer.jpg'"/> 
    <SlantBottom/>
    ...
    <SlantTop/>
    <BookToday 
    :title="'Book your Fridge or Freezer repair today'"
...
export default {
  data() {
    return {
        issuesArray: [
            { id: 1, issue: 'Not making ice?' },
            { id: 2, issue: 'Ice on back wall?' },
            { id: 3, issue: 'Leaking water dispenser?' },
            { id: 4, issue: 'Condensation inside?' },
            { id: 5, issue: 'Not cold?' },
            { id: 6, issue: 'No light?' },
            { id: 7, issue: 'Too cold?' },
            { id: 8, issue: 'Not freezing?' },
            { id: 9, issue: 'Broken thermostat?' },
            { id: 10, issue: 'No power?' }
        ],
        accordionData: [
        ...
        bookBodyArray: [
          { id: 1, body: 'Our factory-trained technicians can repair Fridges & Freezers of any make or model, and can also replace any damaged parts quickly.' },
          { id: 2, body: `If you call us before 10 am, we'll be able to fix your appliance the same day. So, regardless of the work your Fridge or Freezer needs, call us.` },
        ]
    }
  },
  head: {
    ...
    meta: [
      ...
      },
      {
          hid: "og:url",
          property: 'og:url',
          content: 'https://anyrep.co.uk/fridge-and-freezer-repairs/'
      },
      {
          hid: "og:type",
          property: 'og:type',
      ...
      },
      {
          hid: "og:title",
          property: 'og:title',
          content: 'Fridge Freezer Repairs Norwich | Anyrep'
      },
      {
          hid: "og:description",
