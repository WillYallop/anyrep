...
export default {
    data() {
        return {
            services: [
                { id: 4, image: 'tumbledyrer.jpg', title: 'Tumbledryers', highlightText: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque malesuada nibh feugiat metus bibendum, sed faucibus arcu tempus. Donec dictum, nisi at molestie interdum, ex nunc dictum dui, quis gravida orci nibh in sapien. Suspendisse potenti. Cras ac vestibulum est, vitae mattis turpis. Ut a justo mi. Curabitur molestie lobortis vulputate.', btnHref: '/tumbledryers-repairs', btnText: 'Find out more' },
                { id: 5, image: 'cooker.jpg', title: 'Cookers', highlightText: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque malesuada nibh feugiat metus bibendum, sed faucibus arcu tempus. Donec dictum, nisi at molestie interdum, ex nunc dictum dui, quis gravida orci nibh in sapien. Suspendisse potenti. Cras ac vestibulum est, vitae mattis turpis. Ut a justo mi. Curabitur molestie lobortis vulputate.', btnHref: '/cooker-repairs', btnText: 'Find out more' },
                { id: 6, image: 'commercialAppliances.jpg', title: 'Commercial Appiances', highlightText: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque malesuada nibh feugiat metus bibendum, sed faucibus arcu tempus. Donec dictum, nisi at molestie interdum, ex nunc dictum dui, quis gravida orci nibh in sapien. Suspendisse potenti. Cras ac vestibulum est, vitae mattis turpis. Ut a justo mi. Curabitur molestie lobortis vulputate.', btnHref: '/commercial-appliance-repairs', btnText: 'Find out more' }
            ]
        }
    },
    methods: {
